                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        border: Border(
                          bottom: BorderSide(
                            color: Color(0xFFBDBDBD), // Same as default underline
                            width: 1.0,
                          ),
                        ),
                      ),
                        ...
                        child: DropdownButton<String>(
                          ...
                          items: const [
                            DropdownMenuItem(
                              value: '+234',
                              child: Row(
                                children: [Text('🇳🇬'), SizedBox(width: 8), Text('+234')],
                              ),
                            ),
                            DropdownMenuItem(
                              value: '+1',
                              child: Row(
                                children: [Text('🇺🇸'), SizedBox(width: 8), Text('+1')],
                              ),
                            ),
                            DropdownMenuItem(
                              value: '+44',
                              child: Row(
                                children: [Text('🇬🇧'), SizedBox(width: 8), Text('+44')],
                              ),
                            ),
                            DropdownMenuItem(
                              value: '+91',
                              child: Row(
                                children: [Text('🇮🇳'), SizedBox(width: 8), Text('+91')],
                              ),
                            ),
                          ],
                          onChanged: (value) {
                            if (value != null) {
                              setState(() {
                                ...
                                _selectedCountryFlag = value == '+234' ? '🇳🇬' : value == '+1' ? '🇺🇸' : value == '+44' ? '🇬🇧' : '🇮🇳';
                              });
                            }
                          },
                        ),
